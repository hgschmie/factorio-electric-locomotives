...
--
-- Must be defined in This.remote_apis. If an API is present, finds scripts.remote-apis.<api-name> and calls
-- - runtime() in runtime phase
--
-- runtime() is called if the API is present in the current game.
----------------------------------------------------------------------------------------------------

---@class framework.RemoteApisManager
local RemoteApis = {}
